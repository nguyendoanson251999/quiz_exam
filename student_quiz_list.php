					...
					<tr>
						...
						<td>
							<center>
								...
								<?php else: ?>
								<a class="btn btn-sm btn-outline-primary" href="student_quiz_list.php <?php $del_answer = $conn->query("DELETE from answers where quiz_id = '".$row['id']."' and user_id ='".$_SESSION['login_id']."' ");
								$del_history = $conn->query("DELETE from history where quiz_id = '".$row['id']."' and user_id ='".$_SESSION['login_id']."' ");?>"><i class="fa fa-eye"></i> Restart</a>
							<?php endif; ?>
							</center>
						</td>
					</tr>
